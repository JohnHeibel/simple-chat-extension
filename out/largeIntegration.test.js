...
exports.EXPECTED_RESULT = exports.MODEL_GENERATED_DIFF = exports.README = exports.STARTER_CODE = void 0;
exports.runLargeIntegrationTest = runLargeIntegrationTest;
...
if __name__ == '__main__':
    ...
    runner.run(suite)
`;
exports.STARTER_CODE = STARTER_CODE;
...
+        self.request_counts.clear()
 ...
 if __name__ == '__main__':`;
exports.MODEL_GENERATED_DIFF = MODEL_GENERATED_DIFF;
 ...
 */
function runLargeIntegrationTest() {
    ...
    console.log('-'.repeat(80));
    const patchResult = (0, patchApplier_1.applyPatch)(STARTER_CODE, MODEL_GENERATED_DIFF);
    ...
    try {
        ...
        let errorMessage = '';
        try {
            const result = (0, child_process_1.execSync)(`cd "${tempDir}" && python3 rate_limiter.py 2>&1`, {
                encoding: 'utf8',
                maxBuffer: 1024 * 1024,
                timeout: 10000,
            });
...
//# sourceMappingURL=largeIntegration.test.js.map